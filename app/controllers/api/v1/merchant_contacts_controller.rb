class Api::V1::MerchantContactsController < Api::V1::BaseController
  ...
  def contact_csv
    begin
      ...
      response = 'Unable to upload contacts csv'
      ExceptionNotifier.notify_exception(e, env: request.env, data: { message: 'In v1 merchant_contacts contact_csv_upload', env: Rails.env })
    end
