...
class NexmoMmsEvent
  ...
  def save_message
    ...
    ExceptionNotifier.notify_exception(e, data: { message: 'In save_message record not unique', env: Rails.env, params: @params[:message_uuid] })
  rescue ActiveRecord::RecordInvalid => e
    ExceptionNotifier.notify_exception(e, data: { message: 'In save_message record invalid', env: Rails.env, params: @params[:message_uuid] })
  rescue StandardError => e
    ExceptionNotifier.notify_exception(e, data: { message: 'In save_message', env: Rails.env, params: @params[:message_uuid] })
  end
