...
class FiberneticsEvent
  def process_event(params)
    ...
    @number = Number.includes(user: %i[sms_fee api_cred rules]).find_by(number: @to)
  ...
  def save_received_message(data)
    ...
    ExceptionNotifier.notify_exception(e, data: { message: 'In fibernetics save_received_message record not unique', env: Rails.env, params: @params })
  rescue ActiveRecord::RecordInvalid => e
    ExceptionNotifier.notify_exception(e, data: { message: 'In fibernetics save_received_message record invalid', env: Rails.env, params: @params })
  rescue StandardError => e
    ExceptionNotifier.notify_exception(e, data: { message: 'In fibernetics save_received_message', env: Rails.env, params: @params })
  end
  ...
  def post_message_to_api_user
    ...
    ExceptionNotifier.notify_exception(e, data: { message: 'In post_message_for_api_user standard error', env: Rails.env, params: @params })
  end
end
