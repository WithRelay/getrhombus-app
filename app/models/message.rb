...
#=begin
  ...
  def yo1
    emails = %w(<redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email> <redacted_email>)
...
<redacted_phone_number>,
    ...
    ary.each_with_index do |n, i|
      n = n.to_s
      #user = User.find_by(email: "cpcfunnel#{n[1..3]}@imkgp.com")
      #user = User.find_by(email: "<redacted_email>")
