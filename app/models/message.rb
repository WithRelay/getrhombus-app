...
#=begin
  ...
  def yo
    Number.where(user_id: 35940).each_with_index { |n, i| TextingService.release_number_nexmo(n.number, "CA"); puts i; }
  end
  ...
  def z
    ...
    ary.each_with_index { |n, i| TextingService.update_nexmo_number('CA', n[0], 'tel', <redacted_phone_number>); puts i; }
...
#=end
  ...
  def qwe
    ...
    b.each { |e| puts "#{e}," if a.exclude? e }
