class Image < ActiveRecord::Base
  ...
  IMG_VERSIONS = { thumb: '100x100>', square: '200x200#', medium: '300x300>' }
  ...
  has_attached_file :avatar, styles: lambda { |i| i.instance.uploaded_as.present? ? IMG_VERSIONS : Hash[*Image::IMG_VERSIONS.first] }
