module AddTokenToUser
  ...
  def send_decline_text(message)
    ...
    Conversation.find_or_create_conversation_for_message_and_send_publish(User.get_platform_acct_obj.rhombus_number, self, 'user', customer.id, msg_to_send, "Message")
  end
