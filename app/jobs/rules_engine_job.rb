...
class RulesEngineJob < ApplicationJob
  ...
  EXCLUSIONS = %w[<redacted_phone_number> <redacted_phone_number> <redacted_phone_number> <redacted_phone_number> <redacted_phone_number> <redacted_phone_number> <redacted_phone_number> <redacted_phone_number>].freeze
