...
ActiveRecord::Schema.define(version: 20180822104647) do
  ...
  add_index "lists", ["campaign_type"], name: "index_lists_on_campaign_type", using: :btree
  ...
  create_table "numbers", force: :cascade do |t|
    ...
    t.string   "number_type",               limit: 191
    t.string   "country",                   limit: 191
  ...
  create_table "stripe_creds", force: :cascade do |t|
    ...
    t.boolean  "livemode",                  limit: 1
    t.integer  "user_id",                   limit: 4
    t.integer  "transaction_fee_id",        limit: 4,     default: 3
    t.string   "ip",                        limit: 191
