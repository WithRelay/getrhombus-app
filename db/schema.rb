...
ActiveRecord::Schema.define(version: 20171104135414) do
  ...
  add_index "away_messages", ["user_id"], name: "index_away_messages_on_user_id", unique: true, using: :btree
  ...
  add_index "campaign_lists", ["list_id"], name: "index_campaign_lists_on_list_id", using: :btree
  ...
  create_table "demos", force: :cascade do |t|
    ...
    t.string   "employee_count", limit: 191
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
  end
  ...
  add_index "fb_creds", ["page_specific_id"], name: "index_fb_creds_on_page_specific_id", unique: true, using: :btree
  ...
  add_index "hashtags", ["user_id", "name"], name: "index_hashtags_on_user_id_and_name", using: :btree
  ...
  add_index "invoices", ["coupon_id"], name: "fk_rails_ee4edc95fb", using: :btree
  add_index "invoices", ["stripe_invoice_id"], name: "index_invoices_on_stripe_invoice_id", using: :btree
  add_index "invoices", ["subscription_id"], name: "fk_rails_aff20396c6", using: :btree
  add_index "invoices", ["transaction_id"], name: "fk_rails_f221e58c83", using: :btree
  ...
  create_table "lists", force: :cascade do |t|
    ...
    t.integer  "list_type",     limit: 4,     default: 0
  ...
  add_index "message_resolutions", ["user_id"], name: "index_message_resolutions_on_user_id", using: :btree
