class AddUrlFieldsToMerchantContacts < ActiveRecord::Migration
  def change
    ...
    add_column :users, :url6, :string
    add_column :users, :url7, :string
    add_column :users, :url8, :string
    add_column :users, :url9, :string
    add_column :users, :url10, :string
    add_column :users, :url11, :string
    add_column :users, :url12, :string
    add_column :users, :url13, :string
    add_column :users, :url14, :string
    add_column :users, :url15, :string
    add_column :users, :url16, :string
    add_column :users, :url17, :string
    add_column :users, :url18, :string
    add_column :users, :url19, :string
    add_column :users, :url20, :string
  end
end
