...
csv_contact_import_worker: bundle exec rake resque:work QUEUE=csv_contact_import $RAILS_ENV TERM_CHILD=1 RESQUE_TERM_TIMEOUT=7
csv_customer_import_worker: bundle exec rake resque:work QUEUE=csv_customer_import $RAILS_ENV TERM_CHILD=1 RESQUE_TERM_TIMEOUT=7
