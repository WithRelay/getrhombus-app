...
desc "notify users to update card info"
task :profile_reminder => :environment do
	...
	numbers = [ "<redacted_phone_number>", "<redacted_phone_number>", '<redacted_phone_number>', '<redacted_phone_number>', "<redacted_phone_number>",
	...
	# numbers = ["<redacted_phone_number>", "<redacted_phone_number>"]
	# Others
	# "<redacted_phone_number>", "<redacted_phone_number>",
	# "<redacted_phone_number>", "<redacted_phone_number>", "<redacted_phone_number>", "<redacted_phone_number>", "<redacted_phone_number>",
	# "<redacted_phone_number>", "<redacted_phone_number>",
