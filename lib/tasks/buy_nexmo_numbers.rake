...
=end
  # cpc - <redacted_phone_number>
  # # ucp voterid - <redacted_phone_number>

  ary = []
  # toll free provisioning
  users = User.where(id: [29804])             # <<<<-------------------
  #  29590, 29591, 29592
  #  <redacted_phone_number>
  country = 'CA'
  pattern = '1403'                             # <<<<-------------------
