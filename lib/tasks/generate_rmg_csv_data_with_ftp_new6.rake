...
task generate_rmg_csv_data_with_ftp_new6: :environment do
  ...
  header = ['Total', 'Campaign Name', 'Date Sent', 'Email', 'Template', 'Unique Inbound Numbers',
            'Total Inbound messages'].freeze
  ...
  csv_string = CSV.generate do |csv|
    ...
    users.each_with_index do |user, i|
      ...
      next unless campaigns.present?

      campaigns.each_with_index do |c, _i|
