...
class HashtagsControllerTest < ActionController::TestCase
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post :create, hashtag: { amount: @hashtag.amount, is_precedent: @hashtag.is_precedent, name: @hashtag.name, response: @hashtag.response, tag: @hashtag.tag }
    end
  ...
  test "should update hashtag" do
    patch :update, id: @hashtag, hashtag: { amount: @hashtag.amount, is_precedent: @hashtag.is_precedent, name: @hashtag.name, response: @hashtag.response, tag: @hashtag.tag }
    assert_redirected_to hashtag_path(assigns(:hashtag))
  end
