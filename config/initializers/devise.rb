...
Devise.setup do |config|
  ...
  config.mailer_sender = Rails.application.secrets.team_email       # 7/20/14
  ...
  # config.pepper = "03c8b6cf691d13e5d0bfe7bc51580b91d8ae0f569e42a8960c18f816fc7ee49f255430e76b26c60fe6575eb36e402c28db821d1b0a87819a4a5082680609b7c2"
  ...
  config.omniauth :stripe_connect, Rails.application.secrets.stripe["oauth"], Rails.application.secrets.stripe["secret_key"], :scope => 'read_write', :stripe_landing => 'register'
