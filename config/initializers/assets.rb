...
Rails.application.config.assets.precompile += %w( tokenize.js forms.css mainly_static_pages.css 500.html utils.js custom.js chartist.js bootstrap-select.js )       # added
