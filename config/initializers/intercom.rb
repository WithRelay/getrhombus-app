IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "c9fe3dff770203a5d1976dbe60fe450731e3d425"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  # config.api_secret: '<redacted_api_secret>'
  ...
  #
  config.enabled_environments = ["production"] #["development", "production"]
